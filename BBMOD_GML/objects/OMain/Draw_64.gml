...
with (OZombie)
{
	...
	var _screenPos = _cam.world_to_screen(new BBMOD_Vec3(x, y, z + 42), _windowWidth, _windowHeight);
	if (!_screenPos)
	{
...
with (OFloatingText)
{
	var _screenPos = _cam.world_to_screen(new BBMOD_Vec3(x, y, z), _windowWidth, _windowHeight);
	if (!_screenPos)
	{
